...
static TK_API_RESULT tk_gfx_createVulkanSDFPipeline(
...
// layout
    ...
    NH_GFX_CHECK_VULKAN_2(TK_API_ERROR_BAD_STATE, Driver_p->Functions.vkCreateDescriptorSetLayout(Driver_p->Device, &LayoutInfo, VK_NULL_HANDLE, &Layout))
...
// shader
    ...
    NH_CORE_CHECK_2(TK_API_ERROR_BAD_STATE, nh_gfx_createVulkanShaderModule(Driver_p, vs_code, sizeof(vs_code), &vertShaderModule))
    NH_CORE_CHECK_2(TK_API_ERROR_BAD_STATE, nh_gfx_createVulkanShaderModule(Driver_p, fs_code, sizeof(fs_code), &fragShaderModule))
...
// create
    ...
    NH_CORE_CHECK_2(TK_API_ERROR_BAD_STATE, nh_gfx_createVulkanPipeline(Driver_p, NH_VK_PIPELINE_GRAPHICS, &PipelineLayoutInfo, &PipelineInfo, Pipeline_p))
...
static TK_API_RESULT tk_gfx_createVulkanBackgroundPipeline(
    nh_gfx_VulkanDriver *Driver_p, nh_gfx_VulkanPipeline *Pipeline_p, nh_gfx_VulkanPipelineInfo *Info_p)
{
    ...
    NH_CORE_CHECK_2(TK_API_ERROR_BAD_STATE,
...
static TK_API_RESULT tk_gfx_createVulkanClearAlphaPipeline(
    nh_gfx_VulkanDriver *Driver_p, nh_gfx_VulkanPipeline *Pipeline_p, nh_gfx_VulkanPipelineInfo *Info_p)
{
    ...
    nh_gfx_VulkanDriver *Driver_p, nh_gfx_VulkanPipeline *Pipelines_p)
{
    ...
    TK_GFX_CHECK(tk_gfx_createVulkanSDFPipeline(Driver_p, &Pipelines_p[TK_GFX_VULKAN_PIPELINE_SDF], &Info))
    TK_GFX_CHECK(tk_gfx_createVulkanBackgroundPipeline(Driver_p, &Pipelines_p[TK_GFX_VULKAN_PIPELINE_BACKGROUND], &Info))
    TK_GFX_CHECK(tk_gfx_createVulkanClearAlphaPipeline(Driver_p, &Pipelines_p[TK_GFX_VULKAN_PIPELINE_CLEAR_ALPHA], &Info))
...
void tk_gfx_destroyVulkanPipelines(
    nh_gfx_VulkanDriver *Driver_p, nh_gfx_VulkanPipeline *Pipelines_p)
{
    for (int i = 0; i < _TK_GFX_VULKAN_PIPELINE_COUNT; ++i) {
