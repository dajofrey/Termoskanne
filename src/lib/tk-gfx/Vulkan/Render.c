...
static void tk_gfx_recordVulkanDim(
    tk_gfx_VulkanDim *Dim_p, nh_gfx_VulkanGPU *GPU_p, VkCommandBuffer *CommandBuffer_p, unsigned int vertices)
{
    GPU_p->Driver.Functions.vkCmdBindPipeline(
        *CommandBuffer_p, VK_PIPELINE_BIND_POINT_GRAPHICS, 
        GPU_p->Term.Pipelines_p[TK_GFX_VULKAN_PIPELINE_BACKGROUND].Pipeline
    );
...
static void tk_gfx_recordVulkanClearAlpha(
    nh_gfx_VulkanGPU *GPU_p, VkCommandBuffer *CommandBuffer_p)
{
    GPU_p->Driver.Functions.vkCmdBindPipeline(
        *CommandBuffer_p, VK_PIPELINE_BIND_POINT_GRAPHICS, 
        GPU_p->Term.Pipelines_p[TK_GFX_VULKAN_PIPELINE_CLEAR_ALPHA].Pipeline
    );
...
static void tk_gfx_recordVulkanBackground(
    tk_gfx_VulkanBackground *Background_p, nh_gfx_VulkanGPU *GPU_p, VkCommandBuffer *CommandBuffer_p, int indices)
{
    GPU_p->Driver.Functions.vkCmdBindPipeline(
        *CommandBuffer_p, VK_PIPELINE_BIND_POINT_GRAPHICS, 
        GPU_p->Term.Pipelines_p[TK_GFX_VULKAN_PIPELINE_BACKGROUND].Pipeline
...
static void tk_gfx_recordVulkanForeground(
    tk_gfx_VulkanForeground *Text_p, nh_gfx_VulkanGPU *GPU_p, VkCommandBuffer *CommandBuffer_p, int indices)
{
    GPU_p->Driver.Functions.vkCmdBindPipeline(
        *CommandBuffer_p, VK_PIPELINE_BIND_POINT_GRAPHICS, 
        GPU_p->Term.Pipelines_p[TK_GFX_VULKAN_PIPELINE_SDF].Pipeline
    );
    VkDeviceSize size_p[1] = {0};
    ...
    GPU_p->Driver.Functions.vkCmdBindDescriptorSets(
        *CommandBuffer_p, VK_PIPELINE_BIND_POINT_GRAPHICS,
        GPU_p->Term.Pipelines_p[TK_GFX_VULKAN_PIPELINE_SDF].PipelineLayout,
    ...
    tk_gfx_Grid *BackdropGrid_p)
{
    ...
    TK_GFX_CHECK(tk_gfx_updateVulkanBackground(
    ...
    TK_GFX_CHECK(tk_gfx_updateVulkanForeground(
        Graphics_p->State.Viewport_p->Surface_p->Vulkan.GPU_p,
        FontInstance_p,
    ...
    TK_GFX_CHECK(tk_gfx_updateVulkanDim(
        Graphics_p->State.Viewport_p->Surface_p->Vulkan.GPU_p,
