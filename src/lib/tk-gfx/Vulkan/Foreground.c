...
static TK_API_RESULT tk_gfx_createTextVertices(
    nh_gfx_VulkanDriver *Driver_p, tk_gfx_VulkanForeground *Text_p, nh_core_Array *Vertices_p, nh_core_Array *Indices_p)
{
...
static TK_API_RESULT tk_gfx_createTextUniform(
    nh_gfx_VulkanDriver *Driver_p, tk_gfx_VulkanForeground *Text_p)
{
    // MVP
    float vsData_p[16];
...
static TK_API_RESULT tk_gfx_createTextDescriptor(
    nh_gfx_VulkanGPU *GPU_p, tk_gfx_VulkanForeground *Text_p)
{
    ...
    NH_CORE_CHECK_2(TK_API_ERROR_BAD_STATE, nh_gfx_createVulkanDescriptorSet(Driver_p, &AllocateInfo, &LayoutInfo, &Text_p->DescriptorSet))

    return TK_API_SUCCESS;
}

static TK_API_RESULT tk_gfx_updateTextDescriptor(
    nh_gfx_VulkanGPU *GPU_p, tk_gfx_VulkanForeground *Text_p, nh_vk_Texture *Texture_p)
{
    nh_gfx_VulkanDriver *Driver_p = &GPU_p->Driver;
    ...
    nh_gfx_VulkanGPU *GPU_p, tk_gfx_VulkanForeground *Text_p)
{
    ...
    TK_GFX_CHECK(tk_gfx_createTextDescriptor(GPU_p, Text_p))
    ...
    nh_core_Array *Indices_p)
{
    ...
    TK_GFX_CHECK(tk_gfx_createTextVertices(&GPU_p->Driver, Text_p, Vertices_p, Indices_p))
    TK_GFX_CHECK(tk_gfx_createTextUniform(&GPU_p->Driver, Text_p))
    TK_GFX_CHECK(tk_gfx_updateTextDescriptor(GPU_p, Text_p, Texture_p))
...
//TK_API_RESULT tk_gfx_destroyVulkanForeground(
//    nh_gfx_VulkanGPU *GPU_p, tk_gfx_VulkanForeground *Text_p)
//{
//    nh_gfx_destroyVulkanBuffer(&GPU_p->Driver, &Text_p->VertexBuffer);
//    nh_gfx_destroyVulkanBuffer(&GPU_p->Driver, &Text_p->IndexBuffer);
