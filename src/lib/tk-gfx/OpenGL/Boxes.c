...
static TK_API_RESULT tk_gfx_initOpenGLBoxesVertices(
    tk_gfx_OpenGLBoxes *Boxes_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
...
static TK_API_RESULT tk_gfx_updateOpenGLBoxesVertices(
    tk_gfx_Boxes *Boxes_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
...
{
    tk_gfx_Boxes *Boxes_p = data_p;
    tk_gfx_GraphicsState *State_p = state_p;

    if (Boxes_p->Action.init) {
        tk_gfx_initOpenGLBoxesVertices(
            &Boxes_p->OpenGL, State_p->Viewport_p->OpenGL.CommandBuffer_p);
        Boxes_p->Action.init = false;
    }

    tk_gfx_updateOpenGLBoxesVertices(Boxes_p, State_p->Viewport_p->OpenGL.CommandBuffer_p);
...
{
    memset(Boxes_p, 0, sizeof(tk_gfx_OpenGLBoxes));
