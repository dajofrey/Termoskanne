...
static TK_API_RESULT tk_gfx_initOpenGLForegroundPrograms(
    tk_gfx_OpenGLForeground *Foreground_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
...
static TK_API_RESULT tk_gfx_initOpenGLFontTextures(
    tk_gfx_OpenGLForeground *Foreground_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
...
static TK_API_RESULT tk_gfx_initOpenGLForegroundVertices(
    tk_gfx_OpenGLForeground *Foreground_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
...
static TK_API_RESULT tk_gfx_updateOpenGLForegroundFont(
    tk_gfx_Config *Config_p, tk_gfx_GraphicsState *State_p,
    tk_gfx_GraphicsForeground *Foreground_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
    // regular
...
static TK_API_RESULT tk_gfx_updateOpenGLForegroundVertices(
    tk_gfx_GraphicsForeground *Foreground_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
    ...
    void *Config_p, void *state_p, void *data_p)
{
    ...
    tk_gfx_GraphicsData *Data_p = data_p;

    if (Data_p->Foreground.Action.init) {
        tk_gfx_initOpenGLFontTextures(&Data_p->Foreground.OpenGL, 
            State_p->Viewport_p->OpenGL.CommandBuffer_p);
        tk_gfx_initOpenGLForegroundPrograms(&Data_p->Foreground.OpenGL, 
            State_p->Viewport_p->OpenGL.CommandBuffer_p);
        tk_gfx_initOpenGLForegroundVertices(&Data_p->Foreground.OpenGL, 
            State_p->Viewport_p->OpenGL.CommandBuffer_p);
        Data_p->Foreground.Action.init = false;
    }

    tk_gfx_updateOpenGLForegroundFont(
        Config_p, State_p, &Data_p->Foreground, State_p->Viewport_p->OpenGL.CommandBuffer_p);

    tk_gfx_updateOpenGLForegroundVertices(
...
{
    memset(Foreground_p, 0, sizeof(tk_gfx_OpenGLForeground));
