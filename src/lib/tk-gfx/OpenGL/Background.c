...
static TK_API_RESULT tk_gfx_initOpenGLBackgroundProgram(
    tk_gfx_OpenGLBackground *Background_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
...
static TK_API_RESULT tk_gfx_initOpenGLBackgroundVertices(
    tk_gfx_OpenGLBackground *Background_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
...
static TK_API_RESULT tk_gfx_updateOpenGLBackgroundVertices(
    tk_gfx_OpenGLBackground *Background_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p, nh_core_Array *Vertices_p,
    ...
    void *state_p, void *data_p)
{
    ...
    if (Data_p->Background.Action.init) {
        tk_gfx_initOpenGLBackgroundProgram(&Data_p->Background.OpenGL, 
            State_p->Viewport_p->OpenGL.CommandBuffer_p);
        tk_gfx_initOpenGLBackgroundVertices(&Data_p->Background.OpenGL, 
            State_p->Viewport_p->OpenGL.CommandBuffer_p);
        Data_p->Background.Action.init = false;
    }

    tk_gfx_updateOpenGLBackgroundVertices(&Data_p->Background.OpenGL,
...
{
    memset(Background_p, 0, sizeof(tk_gfx_OpenGLBackground));
