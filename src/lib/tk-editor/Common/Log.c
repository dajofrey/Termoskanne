...
//TK_API_RESULT tk_core_logTerminalMode(
//    tk_core_Shell *Shell_p, int mode)
//{
//TK_CORE_BEGIN()
//
//    char *description_p = tk_core_getSessionModeDescription(mode);
//
//    char message_p[255];
...
TK_API_RESULT _tk_core_logBegin(
...
TK_API_RESULT _tk_core_logDiagnosticEnd(
